                          ...
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                ...
                                <td class="numeric">
                                  <a href="<?php echo base_url(); ?>index.php/admin/welcome/edit_pegawai/<?php echo $list['id'] ?>"><button type="button"  class="btn btn-theme02"><i class="fa fa-check"></i> Ubah</button></a>
                                </td>
                              </tr>
                              <?php $no++ ; }?>
                              </tbody>
