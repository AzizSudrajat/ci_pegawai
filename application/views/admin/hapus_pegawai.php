...
<section id="main-content">
    <section class="wrapper">
      <h3><i class="fa fa-angle-right"></i> Table Ubah Pegawai</h3>
        <div class="row mt">
          <div class="col-lg-12">
                      <div class="content-panel">
                      <h4><i class="fa fa-angle-right"></i> Mengubah Pegawai</h4>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
                                ...
                                <td class="numeric">
                                  <a href="<?php echo base_url(); ?>index.php/admin/welcome/hapus_pegawai/<?php echo $list['id'] ?>"><button type="button"  class="btn btn-theme02"><i class="fa fa-check"></i> Hapus</button></a>
                                </td>
                              </tr>
                              <?php $no++ ; }?>
                              </tbody>
